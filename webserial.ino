...
void loop() {
  ...
  int dynamicBaseSpeed = baseSpeed * (1.0 - 0.5 * turnFactor);
  dynamicBaseSpeed = constrain(dynamicBaseSpeed,130,baseSpeed);

  int adjust = correction * dynamicBaseSpeed;
